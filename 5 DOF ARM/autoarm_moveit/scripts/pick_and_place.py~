...
from autoarm_poses.msg import GenerateGraspPosesAction
from autoarm_poses.msg import GenerateGraspPosesGoal
from autoarm_poses.msg import GraspPoseOptions
...
class Pick_Place:
    ...
    def __init__(self):
        ...
        self._pose_place.position.x = self._pose_coke_can.position.x - 1
        ...
        self._grasps_ac = SimpleActionClient('/autoarm_grasp_pose_server/generate_grasp_poses', GenerateGraspPosesAction)
